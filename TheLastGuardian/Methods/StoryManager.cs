namespace TheLastGuardian.Methods
{
    public static class StoryManager
    {
        public static void IntroStory(Player player)
        {
            ...
            {
                case "🏹 Hunter":
                    Console.WriteLine("Silent as the night, your enemies will fall\n" +
                                      "before they even know you were there.");
                    Console.WriteLine("From the ruins of Earth to the far reaches\n" +
                                      "of the system, your path is one of precision and cunning.\n");
                    break;

                case "🛡️ Titan":
                    Console.WriteLine("You are the wall that shall never crumble.\n" +
                                      "A defender of humanity.");
                    Console.WriteLine("When the Darkness advances, you will stand tall,\n" +
                                      "unshaken, and unbroken.\n");
                    break;

                case "🔮 Warlock":
                    Console.WriteLine("You wield the secrets of the universe as both weapon and shield.");
                    Console.WriteLine("The arcane bends to your will,\n" +
                                      "and through knowledge, you will master the battlefield.\n");
                    break;
            }

            Console.WriteLine("But the Darkness stirs once more...");
            Console.WriteLine("Old enemies rise from the shadows,\n" +
                              "and whispers speak of a great threat looming beyond the stars.\n");
